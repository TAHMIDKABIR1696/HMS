...
<head>
    ...
    <title>EcoCare - DOCTOR Dashboard</title>
    ...
    <div class="app-container">
        ...
        <div class="sidebar">
            ...
            <ul class="nav-links">
                ...
                <li>
                    <li><a href="{{ route('doctor.profile') }}"><i class="fas fa-calendar-check"></i> Profile</a></li>
                    <a href="{{ route('logout') }}"
            ...
            <div class="dashboard-content">
                ...
                <div class="quick-actions">
                    ...
                    <div class="action-grid">
                        <a href="{{ route('doctor.appointment') }}" class="action-card">
                        ...
                        <a href="{{ route('doctor.income') }}" class="action-card">
                            <div class="action-icon">
                        ...
                        <a href="{{ route('doctor.patienthistory') }}" class="action-card">
                            <div class="action-icon">
