...
<head>
    ...
    <title>EcoCare - Patients Management</title>
    ...
    <div class="main-layout">
        ...
        <div class="sidebar">
            ...
            <ul class="nav-links">
                ...
                <li><a href="#" class="active"><i class="fas fa-users"></i> <span>Patients</span></a></li>
                <li>
        ...
        <div class="content-area">
            <div class="page-header">
                <h1 class="page-title"><i class="fas fa-users"></i> Patients</h1>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-cell">
                                    <div class="icon-btn view-btn"><i class="fas fa-eye"></i></div>
                                    <div class="icon-btn edit-btn"><i class="fas fa-edit"></i></div>
                                    <div class="icon-btn delete-btn" onclick="showDeleteModal({{ $patient->id }}, '{{ $patient->name }}')">
...
<div class="modal" id="deleteModal">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <p>Are you sure you want to delete <strong id="patientName"></strong>? This action cannot be undone.</p>
        </div>
...
function showDeleteModal(id, name) {
    ...
    document.getElementById('deleteForm').action = `/admin/patients/${id}`;
}
