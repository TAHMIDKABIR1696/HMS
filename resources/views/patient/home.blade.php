            ...
            <div class="bg-white shadow-lg sm:rounded-xl p-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <a href="{{ route('patient.ambulance-booking') }}" 
                       class="block bg-red-600 hover:bg-red-700 text-white font-semibold py-5 px-6 rounded-lg shadow-md transition transform hover:scale-105 text-center">
                        🚑 Book Ambulance
                    </a>
